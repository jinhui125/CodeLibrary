...
if __name__ == '__main__':
    test = DataVisual(csv_cpu=r'./data_file/tmp_file/AppCPU-HMI性能分析-2023-12-12 16_46_50.csv',
                      csv_mem=r'./data_file/tmp_file/MemPSS-HMI性能分析-2023-12-12 16_46_50.csv',

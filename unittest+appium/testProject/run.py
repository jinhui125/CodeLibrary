...
testcasesPath = os.path.join(rootPath, "testcase\jumei_APP\main_page_testcases")
...
with open(report_file, "w", encoding="utf-8") as rf:
    discover = unittest.defaultTestLoader.discover(start_dir=testcasesPath, pattern="home_interface_inspect_main.py")
